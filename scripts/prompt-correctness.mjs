...
const CASES = [
  ...
  { ask: "something dark",
    must: cs => cs.every(c => /^Dark /.test(c.n) || /Rocket|Team Aqua|Team Magma|Giovanni/i.test(c.n) || /Rocket/i.test(c.s)),
    say: "Dark-prefixed or villain cards, not merely grim-toned ones" },
