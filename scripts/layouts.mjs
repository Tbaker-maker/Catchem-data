...
export const LAYOUTS = {
  ...
  6: { name: "the half page", cols: 3, rows: 2, cardW: 745, cardCaption: 0,
    ...
    why: "2 rows of 3" },
  8: { name: "the page", cols: 2, rows: 4, cardW: 745, cardCaption: 0,
    W: 1730, H: 4520, ratio: 2.61, cardShare: 43, widened: false, cropExempt: true,
    why: "4 rows of 2 — a tall binder page on purpose, not 4 across" },
