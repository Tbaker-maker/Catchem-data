...
const FLEET = [
  ...
  { id: "artifact-freshness", script: "artifact-freshness.mjs", blocking: false,
    does: "Takes every file a scheduled job promises to commit and reports how many runs have passed since it last actually moved. ADVISORY because legitimate quiet exists and blocking on a slow news day would be the same mistake inverted - the failure mode here is nobody LOOKING. This is the sweep that would have caught the radar on day two." },
