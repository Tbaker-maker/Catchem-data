...
const FLEET = [
  ...
  { id: "live-page-smoke", script: "live-page-smoke.mjs", blocking: true,
    does: "Opens the published editor URL in a real browser and asserts the tutorial appears, images paint, the console is clean, and one named ask works. BLOCKING because three launch blockers on 26 Aug passed every other guard and were only found by loading the live page." },
