...
store.coverage = {
  ...
  cards: Object.keys(store.cards).length, cardsWithArtist: withArtist, failures: failures.length,
...
console.log(`✓ catalogue: ${Object.keys(store.cards).length} cards across ${Object.keys(store.sets).length} sets · ${withArtist} carry an artist credit · ${added} new this run`);
