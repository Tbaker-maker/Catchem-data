...
<h2>Raw cards</h2>
<div class="law" style="border-left-color:#36d399"><b>The five-year-old version 🍭</b><br>
A <b>raw</b> card is a card exactly as it came out of the pack — no official checkup yet, no case around it. Its price works like a trading-day at recess: it depends on how nice the card looks and what kids will actually swap for it <i>today</i>. Why we spotlight one raw card each morning: when a whole set starts moving quietly, everyone runs to its coolest card first — so that card is where the action shows before the headlines do.</div>
<p>The grown-up version: raw prices are ungraded market rates for well-kept copies. Our daily raw watch picks the top chase inside whichever set moved without news coverage — quiet set movement usually surfaces in its flagship single first.</p>
<h2>Graded cards &amp; the Grading Premium</h2>
<div class="law" style="border-left-color:#c77dff"><b>The five-year-old version 🍭</b><br>
Grading means mailing your card to the <b>card doctors</b>. They examine it with magnifying glasses, give it a score out of 10, and seal it in a clear case forever. A <b>10</b> means practically perfect. The <b>Grading Premium</b> answers one question: <i>if I pay the doctor $79.99, do I get back MORE than my card was worth before the checkup?</i> Picture a card worth about $1,500 raw whose perfect-10 copies sell near $5,000 — that checkup turned it into a much bigger card, even after paying the doctor. <b>But here is the catch grown-ups miss:</b> usually only the 10 pays. A 9 — one tiny scratch — often gets you back <i>less</i> than the raw card plus the fee. Grading is a ticket, and on most established cards, 10 is the only winning number. Brand-new sets bend this rule for a while (so few graded copies exist that even 9s sell strong) — and that bend fades as more copies get graded.</div>
<p>The grown-up version: premium = graded sold price minus raw market minus the grading fee. Established-set 9s routinely run negative — the grading tax — while fresh sets can pay at 9 until graded supply catches up. Exact per-card premium figures publish on our licensed surfaces.</p>
