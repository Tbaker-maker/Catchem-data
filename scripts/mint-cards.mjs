...
if (six) await mint("index", card({ label: "CATCH'EM SEALED INDEX", title: `${six.constituents} sealed products, one number`,
  ...
  why: "Equal-weight composite of every tracked sealed product vs its own clean baseline. Methodology public at catchemtcg.com/methodology.", chip: "VERIFIED", wide: true }));
...
<h2>The Catch'em Sealed Index</h2><p>Equal-weight composite: every tracked sealed product's price today divided by its own first clean-history price, averaged, times 100. Baseline era began <b class="mono">2026-08-18</b> — the day our BIN-only, delivered-price methodology went live. Breadth counts how many products rose vs fell day-over-day. Composition changes don't distort the level because each product is measured against itself.</p>
