...
<h2 id="prices">Prices</h2><p>All prices are natively in <b>US dollars</b> (eBay US marketplace, pinned in code). Choosing CAD in the app shows a converted <i>estimate</i> at the day&#8217;s rate, clearly labeled &#8212; the underlying data never changes currency. Sealed prices are eBay asking medians: Buy-It-Now listings only, delivered price (item + shipping where stated), scam-vocabulary filtered, bounded per product class, with a clean-floor figure that ignores implausible outliers. We do not have sold-price data and we don't pretend to.</p>
