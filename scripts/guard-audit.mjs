...
const MUST_RUN = [
  ...
  { script: "editor-hostile.mjs", why: "the generated page must parse and survive asks a stranger actually types — a merge left two const these and killed NOTICE, evo-smoke and ask-smoke in one SyntaxError" },
