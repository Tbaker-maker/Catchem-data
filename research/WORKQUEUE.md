...
## CLAIMED / IN FLIGHT
- (CC, Aug 19) Marathon: swsh5 lane QA, tests-in-CI, landers v2,
  story-kit expansion, sandbox prep (heat/depth ELI5 dark), weekly
  dry-run, newsletter linked preview.
...
4. Rip-or-Hold v0 via Discord poll + results JSON loop.
5. Creator webhook network v0 (§14b) — needs first webhook from Tyler.
