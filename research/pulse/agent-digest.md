...
- designer: BROKEN RECORD — 4 finding(s) repeated three runs running (e.g. "medium::--faint on the background is 3.2:1"). Either they are not actionable or they are being ignored; the agent should say WHY instead of repeating itself.
