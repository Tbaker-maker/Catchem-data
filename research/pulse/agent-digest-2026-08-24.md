# What the machines noticed — 2026-08-24
...
4 product(s) we featured and can no longer price:
...
- designer: BROKEN RECORD — 6 finding(s) repeated three runs running (e.g. "medium::35 distinct colours"). Either they are not actionable or they are being ignored; the agent should say WHY instead of repeating itself.
...
- **YouTube** — the sealed market — "The whole sealed market in one number: 98.8."
- **TikTok** — Open on the number, not the setup: "The whole sealed market in one number: 98.8."
...
- **build.html** — the accent colour appears 28 times. *Spend it in two places: the active state and the one primary action. Everything else greys.*

## What the agents cannot answer themselves
28 open — 21 need eyes on a rendered page, 7 need a decision.
