...
- **drift** — 9 script(s) are not referenced anywhere: backfill-artists.mjs, build-faq.mjs, build-rip.mjs, centering.mjs. *A script nothing calls is either dead or was wired up and quietly unwired. Both are worth knowing, and neither announces itself.*
...
16 open — 10 need eyes on a rendered page, 6 need a decision.
