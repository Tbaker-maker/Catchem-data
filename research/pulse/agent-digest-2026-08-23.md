...
- teacher: FARMING — findings climbed 17 → 17 → 17 → 18 across four runs with nothing resolved. Volume is not work.
...
- **drift** — 8 script(s) are not referenced anywhere: backfill-artists.mjs, build-creators-page.mjs, collision-guard.mjs, discovery-sweep.mjs. *A script nothing calls is either dead or was wired up and quietly unwired. Both are worth knowing, and neither announces itself.*
...
- **Community 0/10** — Nothing has shipped. There is no community to review.
