...
const CATCHEM_DATA_GH_USER = "YOUR_GITHUB_USERNAME"; // TODO: set to your GitHub username after deploying catchem-data
...
async function fetchSealedFromCDN() {
  // If the user hasn't set up catchem-data yet, skip the CDN fetch.
  if (CATCHEM_DATA_GH_USER === "YOUR_GITHUB_USERNAME") return null;
  try {
