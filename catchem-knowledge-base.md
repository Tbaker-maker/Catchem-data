...
**Locked (Tyler):** Voice v4: no defensive disclaimers on surfaces (chips+verbs+drawer carry posture; definitional+Buy-Pressure lines exempt) · Vocab v3: "sealed products"/"sealed" user-facing, never "SKU"; singles="chases" · English-only · vocab v2 "Buy Pressure (est.)" + disclosure, "Active Listings" (zero user-facing "inferred") · PPT $9.99 tier (ledger; ~$15–20/mo total burn) · grail ceilings $2000/$3000 (dated corrections).
